            ...
            <div class="card card-xxl-stretch mt-4">
                <div class="card-header bg-light bd-cyan">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Notification Create</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="fv-row mb-3">
                                    ...
                                    <select class="form-select form-select-sm rounded-end-0 border-end" data-control="select2"
                                        name="lead_id">
                                        <option value="" {{ old('lead_id') == '' ? 'selected' : '' }}>Nothing Selected</option>
                            ...
                            <div class="col-md-6">
                                <div class="fv-row mb-3">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control form-control-sm form-control-solid flatpickr" name="notify_datetime" value="{{ old('notify_datetime') }}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm  form-control-solid" name="notify_msg" rows="3"></textarea>
                                </div>
                            </div>
