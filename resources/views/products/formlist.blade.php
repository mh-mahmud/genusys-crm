        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Product Form
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Show Product Form List</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <a href="{{ route('dynamictable-create') }}" class="btn btn-sm btn-success" id="kt_toolbar_primary_button">Go to product List</a>
                &nbsp;&nbsp;
                <a href="{{ route('product-form-create') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Create Form</a>
                ...
                <div class="card mt-3">
                    ...
                    <div class="d-flex justify-content-between align-items-start card-header px-2 border-0 pt-1">
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            <form action="{{ route('product-form-search') }}" method="POST" class="d-flex">
                                @csrf
                                <!--begin::Input group-->
