				...
				<div class="toolbar" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center py-1">
                            ...
                            <a href="{{ route('add-product') }}" class="btn btn-sm btn-success" id="kt_toolbar_primary_button">Add Product</a>
									...
									@if($products->isNotEmpty())
										...
										<table class="table table-sm table-condensed table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
											...
											<tr class="fw-bolder text-muted bg-light bd-cyan">
												...
												<th class="min-w-140px">Product Code</th>
												<th class="min-w-140px">Product Type</th>
												<th class="min-w-140px">Purchase Rate</th>
												<th class="min-w-140px">Sale Price</th>
											...
											<tr>
												...
												<td class="text-dark fs-6">{{ $product->product_cost }}</td>
