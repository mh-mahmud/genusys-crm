    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <a href="{{ route('result-group-list') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Result Group
                    List</a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
                ...
                <div class="card card-xxl-stretch mt-4">
                    <div class="card-header bg-light bd-cyan">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Result Group Create</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    ...
                    <div class="card-body pb-2">
                        ...
                        <form class="g-form w-100" action="{{ route('add-result-group-pro') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="fv-row mb-3">
                                        <!--begin::Label-->
                                        <label class="form-label fw-bolder text-dark">Group Code<span
                                                class="text-danger">*</span></label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-sm form-control-solid"
                                               type="text" name="group_code" autocomplete="off" value="{{ old('group_code') }}"/>
                                        <!--end::Input-->
                                ...
                                <div class="col-md-6">
                                    <div class="fv-row mb-3">
                                        <!--begin::Label-->
                                        <label class="form-label fw-bolder text-dark">Group Description<span
                                                class="text-danger">*</span></label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-sm form-control-solid"
                                               type="text" name="group_description" autocomplete="off" value="{{ old('group_description') }}"/>
                                        <!--end::Input-->
